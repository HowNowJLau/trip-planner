    ...
    return (
        <div className="w-100 mx-auto shadow mb-4 rounded border p-4">
            ...
            {srcType === "Google Maps Embed" && (
                <iframe title={description} src={src} width="100%" height="800" allowFullScreen=""
                loading="lazy" className="shadow rounded"></iframe>
            )} 
            {srcType === "Youtube Embed" && (
                <iframe title={description} src={src} width="100%" height="800" allowFullScreen
                loading="lazy" className="shadow rounded"
                allow="accelerometer; autoplay; clipboard-write"></iframe>
            )} 
